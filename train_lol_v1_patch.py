...
parser.add_argument('--img_path', type=str, default='./LOL_v1/our485_patch/low/')
...
for epoch in range(config.num_epochs):
    ...
    if SSIM_mean > ssim_high:
        ...
        torch.save(model.state_dict(), os.path.join(config.snapshots_folder, "best_Epochxiaorong" + '.pth'))
