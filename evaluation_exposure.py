...
parser.add_argument('--img_val_path', type=str, default="/data/unagi0/light_dataset/Exposure_CVPR21/test/INPUT_IMAGES/")
...
with torch.no_grad():
    for i, imgs in tqdm(enumerate(test_loader)):
        ...
        lpips_value = lpips_fn(enhanced_img, high_img).item()
