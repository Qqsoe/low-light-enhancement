...
parser.add_argument('--file_name', type=str, default='demo_imgs/700.png')
parser.add_argument('--normalize', type=bool, default=False)
parser.add_argument('--task', type=str, default='exposure', help='Choose from exposure or enhance')
config = parser.parse_args()

# Weights path
exposure_pretrain = r'./workdirs/snapshots_folder_exposure/best_Epoch.pth1'
enhance_pretrain = r'./workdirs/snapshots_folder_lol_v1_whole/best_Epoch(lol_v1).pth'
